<!--
Topics: type declarations, .d.ts files, declaration files, DefinitelyTyped, @types packages, ambient declarations, declare keyword, triple-slash directives, library types
Keywords: declaration file, d.ts file, type definition, definitely typed, @types, ambient declaration, declare module, declare global, library types, third party types
-->
---
...
## `.d.ts` files
<!-- Topics: declaration file, .d.ts, type definition file -->
