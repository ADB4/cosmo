<!--
Topics: TypeScript basics, static typing, type checking, tsc compiler, type inference, strictness, tsconfig.json, compiling TypeScript, type annotations, downleveling, type errors
Keywords: what is typescript, how to use typescript, typescript compiler, strict mode, typescript errors, type safety, compile typescript, typescript vs javascript, static types
-->
---
title: The Basics
layout: docs
...
<!-- Topics: type checking, static analysis, runtime errors, type errors -->
...
<!-- Topics: non-exception errors, typo detection, logic errors, property access errors -->
...
## Types for Tooling
<!-- Topics: editor support, autocomplete, type inference, IntelliSense -->
...
<!-- Topics: tsc, compiler, compile TypeScript, type checking, emit JavaScript -->
...
<!-- Topics: emit on error, compilation errors, noEmitOnError -->
...
## Explicit Types
<!-- Topics: type annotations, explicit typing, type declarations -->
...
## Erased Types
<!-- Topics: type erasure, JavaScript output, compiled output -->
...
## Downleveling
<!-- Topics: downleveling, target version, ES5, ES6, transpilation -->
...
## Strictness
<!-- Topics: strict mode, strict configuration, strictness flags, noImplicitAny, strictNullChecks -->
