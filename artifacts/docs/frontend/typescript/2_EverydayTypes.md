<!--
Topics: primitives, string, number, boolean, arrays, any, unknown, union types, type aliases, interfaces, type assertions, literal types, null, undefined, enums, bigint, symbol
Keywords: basic types, typescript types, primitive types, array types, object types, type alias vs interface, union type, optional types, type assertion, as keyword, angle bracket assertion, literal type, string literal, numeric literal
-->
---
...
## Arrays
<!-- Topics: array type, Array<T>, T[], array syntax -->
...
## `any`
<!-- Topics: any type, opt out of type checking, gradual typing -->
...
<!-- Topics: variable typing, type annotation, let const type -->
...
## Functions
<!-- Topics: function parameters, return types, function typing, arrow functions -->
...
## Object Types
<!-- Topics: object type, property types, optional properties, type alias, interface -->
...
## Union Types
<!-- Topics: union type, | operator, OR types, multiple types -->
...
## Type Aliases
<!-- Topics: type alias, type keyword, custom types, reusable types -->
...
## Interfaces
<!-- Topics: interface, interface vs type, extending interfaces, declaration merging -->
...
## Type Assertions
<!-- Topics: type assertion, as keyword, angle bracket syntax, override type -->
...
## Literal Types
<!-- Topics: literal type, string literal, numeric literal, boolean literal, const assertions -->
...
## `null` and `undefined`
<!-- Topics: null, undefined, strictNullChecks, optional values -->
...
## Enums
<!-- Topics: enum, numeric enum, string enum, const enum, enum members -->
