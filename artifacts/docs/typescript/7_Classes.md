<!--
Topics: classes, class members, fields, constructors, methods, getters, setters, implements, extends, inheritance, public, private, protected, static members, abstract classes, abstract methods, this types, parameter properties, arrow functions in classes, member visibility
Keywords: class, constructor, class method, class field, getter setter, private field, public field, protected member, static method, abstract class, extend class, implement interface, this type, class inheritance, access modifier
-->
---
title: Classes
layout: docs
...
## Class Members
<!-- Topics: class fields, class methods, class properties, member declaration -->
...
## Class Heritage
<!-- Topics: extends, inheritance, class extension, super keyword -->
...
## Member Visibility
<!-- Topics: public, private, protected, access modifiers, visibility modifiers -->
...
## Static Members
<!-- Topics: static, static method, static field, class static -->
...
## `this` Types
<!-- Topics: this type, this parameter, fluent interface -->
...
<!-- Topics: parameter property, constructor parameter, shorthand initialization -->
...
<!-- Topics: abstract class, abstract method, abstract members, base class -->
...
<!-- Topics: structural typing, duck typing, class compatibility -->
