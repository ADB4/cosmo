<!--
Topics: narrowing, typeof guards, truthiness narrowing, equality narrowing, in operator narrowing, instanceof narrowing, type predicates, discriminated unions, never type, exhaustiveness checking, control flow analysis
Keywords: type narrowing, type guards, typeof check, null check, undefined check, discriminated union, tagged union, type predicate function, is keyword, exhaustive check, unreachable code
-->
---
title: Narrowing
layout: docs
...
## `typeof` type guards
<!-- Topics: typeof, type guard, typeof operator, primitive checks -->
...
## Equality narrowing
<!-- Topics: equality check, === !==, null check, undefined check -->
...
<!-- Topics: in operator, property check, object property narrowing -->
...
<!-- Topics: instanceof, class instance check, constructor check -->
...
## Assignments
<!-- Topics: assignment narrowing, variable reassignment, type refinement -->
...
<!-- Topics: control flow, type analysis, reachability -->
...
<!-- Topics: type predicate, is keyword, user-defined type guard, custom type guard -->
