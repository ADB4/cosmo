...
practice. Using the format popularized by _Effective C++_ and
_Effective Java_ (both Addison-Wesley), this practical book
features 83 items that give specific advice on what to do
and what _not_ to do, and how to think about the language.
...
**Praise for** _**Effective TypeScript**_


_Effective TypeScript_ explores the most common questions we see when working
...
_—Ryan Cavanaugh, engineering lead for TypeScript at Microsoft_


_Effective TypeScript_ ’s second edition is a marvelous addition to an already excellent book.
...
_—Josh Goldberg, open source developer_
_and author of_ Learning TypeScript


_Effective TypeScript_ is not just a guide to one of the world’s most popular programming
...
_—Stefan Baumgartner, senior product architect, Dynatrace,_
_and author of_ TypeScript Cookbook


_Effective TypeScript_, 2nd ed., is a great companion book for engineers who are already
...
_—Boris Cherny, author of_ Programming TypeScript


I’ve been engaged with TypeScript for over 10 years, both in teaching and professional
practice. _Effective TypeScript_ offers sound advice that aligns well with my experience.
...
_—Titian-Cornel Cernicova-Dragomir,_

_software engineer at Bloomberg LP_
...
_—Jesse Hallett, senior software engineer, Hasura_


**SECOND EDITION**
## **Effective TypeScript**

_**83 Specific Ways to Improve Your TypeScript**_
...
See _[http://oreilly.com/catalog/errata.csp?isbn=9781098155063](http://oreilly.com/catalog/errata.csp?isbn=9781098155063)_ for release details.


The O’Reilly logo is a registered trademark of O’Reilly Media, Inc. _Effective TypeScript_, the cover image,
...
**Preface to the First Edition (2019). . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . xxi**


**1.** **Getting to Know TypeScript. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 1**
Item 1: Understand the Relationship Between TypeScript and JavaScript        1
Item 2: Know Which TypeScript Options You’re Using                        8
Item 3: Understand That Code Generation Is Independent of Types           11
Item 4: Get Comfortable with Structural Typing                            18
Item 5: Limit Use of the any Type                                         22


**2.** **TypeScript’s Type System. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 27**
Item 6: Use Your Editor to Interrogate and Explore the Type System           27
Item 7: Think of Types as Sets of Values                                    33
Item 8: Know How to Tell Whether a Symbol Is in the Type Space or
Value Space                                                          40
Item 9: Prefer Type Annotations to Type Assertions                         45
Item 10: Avoid Object Wrapper Types (String, Number, Boolean, Symbol,
BigInt)                                                              50
Item 11: Distinguish Excess Property Checking from Type Checking          53
Item 12: Apply Types to Entire Function Expressions When Possible          56
Item 13: Know the Differences Between type and interface                   60
Item 14: Use readonly to Avoid Errors Associated with Mutation              66
Item 15: Use Type Operations and Generic Types to Avoid Repeating Yourself  72
...
**3.** **Type Inference and Control Flow Analysis. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 89**
Item 18: Avoid Cluttering Your Code with Inferable Types                   90
Item 19: Use Different Variables for Different Types                         96
Item 20: Understand How a Variable Gets Its Type                          99
Item 21: Create Objects All at Once                                      104
Item 22: Understand Type Narrowing                                    106
...
Item 28: Use Classes and Currying to Create New Inference Sites             132


**4.** **Type Design. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 137**
Item 29: Prefer Types That Always Represent Valid States                   137
Item 30: Be Liberal in What You Accept and Strict in What You Produce      142
Item 31: Don’t Repeat Type Information in Documentation                 146
Item 32: Avoid Including null or undefined in Type Aliases                  148
Item 33: Push Null Values to the Perimeter of Your Types                   150
Item 34: Prefer Unions of Interfaces to Interfaces with Unions               154
Item 35: Prefer More Precise Alternatives to String Types                   158
Item 36: Use a Distinct Type for Special Values                            162
Item 37: Limit the Use of Optional Properties                             165
Item 38: Avoid Repeated Parameters of the Same Type                      168
Item 39: Prefer Unifying Types to Modeling Differences                    170
Item 40: Prefer Imprecise Types to Inaccurate Types                        172
Item 41: Name Types Using the Language of Your Problem Domain          177
Item 42: Avoid Types Based on Anecdotal Data                            180


**5.** **Unsoundness and the any Type. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 185**
Item 43: Use the Narrowest Possible Scope for any Types                    185
Item 44: Prefer More Precise Variants of any to Plain any                   188
Item 45: Hide Unsafe Type Assertions in Well-Typed Functions              190
Item 46: Use unknown Instead of any for Values with an Unknown Type      195
Item 47: Prefer Type-Safe Approaches to Monkey Patching                  198
Item 48: Avoid Soundness Traps                                         202
...
**6.** **Generics and Type-Level Programming. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 215**
Item 50: Think of Generics as Functions Between Types                    216
Item 51: Avoid Unnecessary Type Parameters                             221
Item 52: Prefer Conditional Types to Overload Signatures                   227
Item 53: Know How to Control the Distribution of Unions over
Conditional Types                                                   230
Item 54: Use Template Literal Types to Model DSLs and Relationships
Between Strings                                                     234
Item 55: Write Tests for Your Types                                      240
Item 56: Pay Attention to How Types Display                              248
Item 57: Prefer Tail-Recursive Generic Types                              252
Item 58: Consider Codegen as an Alternative to Complex Types             256


**7.** **TypeScript Recipes. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 261**
Item 59: Use Never Types to Perform Exhaustiveness Checking              261
Item 60: Know How to Iterate Over Objects                               267
Item 61: Use Record Types to Keep Values in Sync                         270
Item 62: Use Rest Parameters and Tuple Types to Model Variadic Functions   273
Item 63: Use Optional Never Properties to Model Exclusive Or              276
Item 64: Consider Brands for Nominal Typing                             279


**8.** **Type Declarations and @types. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 283**
Item 65: Put TypeScript and @types in devDependencies                    283
Item 66: Understand the Three Versions Involved in Type Declarations       286
Item 67: Export All Types That Appear in Public APIs                      290
Item 68: Use TSDoc for API Comments                                  291
Item 69: Provide a Type for this in Callbacks if It’s Part of Their API          294
Item 70: Mirror Types to Sever Dependencies                             298
Item 71: Use Module Augmentation to Improve Types                      301


**9.** **Writing and Running Your Code. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 305**
Item 72: Prefer ECMAScript Features to TypeScript Features                305
Item 73: Use Source Maps to Debug TypeScript                            313
Item 74: Know How to Reconstruct Types at Runtime                      319
Item 75: Understand the DOM Hierarchy                                 324
Item 76: Create an Accurate Model of Your Environment                   329
Item 77: Understand the Relationship Between Type Checking and
Unit Testing                                                         332
Item 78: Pay Attention to Compiler Performance                          336


**Table of Contents** **|** **ix**


**10.** **Modernization and Migration. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 343**
Item 79: Write Modern JavaScript                                        344
Item 80: Use @ts-check and JSDoc to Experiment with TypeScript            348
Item 81: Use allowJs to Mix TypeScript and JavaScript                      353
Item 82: Convert Module by Module Up Your Dependency Graph           354
Item 83: Don’t Consider Migration Complete Until You Enable noImplicitAny 360


**Appendix: Item Mapping Between First and Second Editions. . . . . . . . . . . . . . . . . . . . . . . . 363**
...
It’s hard to believe it’s been nearly five years since the first edition of _Effective_
_TypeScript_ [was published. The book and its companion website have both been well](https://effectivetypescript.com)
...
By and large, the material in _Effective TypeScript_ has held up well.
...
than just knowing how a feature works. It requires experience _using_ that feature: time
...
Moreover, thanks to projects like the [Type Challenges, TypeScript developers have](https://tsch.js.org)
become much more ambitious in what they do in the type system. Generics and typelevel programming were covered only lightly in the first edition. Now they get an
...
The _Effective_ books are intended to be the “standard second book” on their topic.
You’ll get the most out of _Effective TypeScript_ if you have some previous practical
...
a language lets you do X, an _Effective_ book will tell you which of those five to use and
why.
...
_Effective C++_ by Scott Meyers (Addison-Wesley Professional). It was unlike any other
...
experiences reading _Effective Java_ by Joshua Bloch (Addison-Wesley Professional)
and _Effective JavaScript_ by David Herman (Addison-Wesley Professional).
...
uation. Scott Meyers, the author of _Effective C++_, gives a memorable example of this.
...
_Figure P-1. Twoslash syntax on the TypeScript playground._
...
different in the future. Check the [Effective TypeScript repo for updated versions of](https://github.com/danvk/effective-typescript)
[the examples in this book. All samples were verified with literate-ts using TypeScript](https://oreil.ly/LFR0l)
5.4.
...
_[https://github.com/danvk/effective-typescript](https://github.com/danvk/effective-typescript)_ .
...
includes the title, author, publisher, and ISBN. For example: “ _Effective TypeScript_,
...
information. You can access this page at _[https://oreil.ly/effective-typescript-2e](https://oreil.ly/effective-typescript-2e)_ .

For news and information about our books and courses, visit _[http://www.oreilly.com](http://www.oreilly.com)_ .
...
Despite my hopes, writing a second edition did not prove any easier or less timeconsuming than the first. In the process, the book has grown from 62 items to 83. In
...
Many new items are based on material that first appeared on the _[Effective TypeScript](https://effectivetypescript.com)_
[blog, though all of these have seen significant revision. Chapter 6 is largely based on](https://effectivetypescript.com)
[my personal experiences building the crosswalk and crudely-typed libraries for Delve](https://oreil.ly/-XQ6A)
at Sidewalk Labs.

Here are the origins of the new items in the second edition:


 - [Item 28 is adapted from the blog post “Use Classes and Currying to Create New](https://oreil.ly/OAApn)
[Inference Sites”.](https://oreil.ly/OAApn)
...
**Preface to the Second Edition** **|** **xvii**
 ...
 - [Item 37 is based on personal experience and Evan Martin’s blog post “Why Not](https://oreil.ly/YJWQR)
[Add an Option for That?”. Cory House’s frequent tweets on this topic gave me](https://oreil.ly/YJWQR)
...
[the blog post “The Trouble with Jsonify: Unify Types Instead of Modeling Small](https://oreil.ly/zVod4)
[Differences”.](https://oreil.ly/zVod4)

 - Item 48 is adapted from the blog post [“The Seven Sources of Unsoundness in](https://oreil.ly/NiTnr)
[TypeScript” with significant input from Ryan Cavanaugh.](https://oreil.ly/NiTnr)
...
Overflow answer explaining dependent types.
 ...
 - [Item 51 is an adaptation of the blog post “The Golden Rule of Generics”, which](https://oreil.ly/yaxs8)
...
[Script 4.1 was released, which culminated in the blog post “TypeScript Splits the](https://oreil.ly/Es6Ep)
[Atom!”.](https://oreil.ly/Es6Ep)
...
[crudely-typed, which eventually led to the blog post “The Display of Types”.](https://oreil.ly/bue9Q)
...
eventually led to my TypeScript Congress 2022 talk: [“TypeScript and SQL: Six](https://oreil.ly/ofuph)
[Ways to Bridge the Divide”.](https://oreil.ly/ofuph)
...
Hicks.
 ...
 - [Item 62 was inspired by an Artsy blog post: “Conditional Types in TypeScript”.](https://oreil.ly/r-7E0)

 - Item 63 originated with Ryan Cavanaugh’s feedback on the first edition, which I
[eventually distilled into a blog post: “Exclusive Or and the Optional never Trick”.](https://oreil.ly/os01S)
Stefan Baumgartner’s enthusiasm for this trick in the _TypeScript Cookbook_
...
ing bug that came back to `new Set("string")` . This led to the blog post [“In](https://oreil.ly/iYGLY)
[Defense of Interface: Using Declaration Merging to Disable ‘Bad Parts’”.](https://oreil.ly/iYGLY)
...
It’s based on the TypeScript wiki and the blog post [“What’s Typescript Compil‐](https://oreil.ly/QRilV)
[ing? Use a Treemap to Find Out”.](https://oreil.ly/QRilV)
...
ting’s _Beautiful Sunrise_, provided a soundtrack for writing and editing.
...
an _Effective_ book. To Scott Meyers for coming up with this format and for his “Effec‐
tive _Effective_ Books” blog post, which provided essential guidance.
...
flow were essential in writing Item 9.
 ...
 - Item 10 builds on similar advice in Item 4 of _Effective JavaScript_ .
...
was inspired by Dan North’s short article in _97 Things Every Programmer Should_
_Know_ (Kevlin, Henney, O’Reilly).
...
thing like this and it existed!
 ...
 - Item 52 owes a debt of gratitude to David Sheldrick’s post on the _Artsy_ blog on
...
February 2019 Meetup.
 ...
 - Item 55 is based on my own writing on Medium and work on the typingschecker tool, which eventually got folded into dtslint.

 - Item 72 was inspired/reinforced by Kat Busch’s Medium post on the various types
of enums in TypeScript, as well as Boris Cherny’s writings on this topic in _Pro‐_
_gramming TypeScript_ (O’Reilly).
...
**Item 1: Understand the Relationship Between TypeScript**
**and JavaScript**
...
TypeScript files use a _.ts_ extension, rather than the _.js_ extension of a JavaScript file. [1]

This doesn’t mean that TypeScript is a completely different language! Since Type‐
Script is a superset of JavaScript, the code in your _.js_ files is already TypeScript.
Renaming _main.js_ to _main.ts_ doesn’t change that.
...
1 You may run across _.tsx_, _.jsx_, _.mts_, _.mjs_, and a few other extensions. These are all TypeScript and JavaScript
files.
...
_Figure 1-1. All JavaScript is TypeScript, but not all TypeScript is JavaScript._
...
Script what your _intent_ is, and this lets it spot places where your code’s behavior does
...
_Figure 1-2. All JavaScript programs are TypeScript programs. But only some JavaScript_
_(and TypeScript) programs pass the type checker._
...
TypeScript’s type system _models_ the runtime behavior of JavaScript. This may result in
...
guarantee the accuracy of its static types is said to be _sound_ . TypeScript’s type system
...
or via a configuration file, _tsconfig.json_ :
...
These are called _implicit_ _`any`_ _s_ because you never wrote the word “any” but still wound
...
**Item 3: Understand That Code Generation Is Independent**
**of Types**
...
pilation to JavaScript is simply removing all the `interface` s, `type` s, and type annota‐
...
2 [The best way to build an intuition for this is by using the TypeScript playground, which shows your Type‐](https://oreil.ly/R0_D5)
...
This works because `class Rectangle` introduces both a type _and_ a value, whereas
`interface` only introduced a type.

The `Rectangle` in `type Shape = Square | Rectangle` refers to the _type_, but the
`Rectangle` in `shape instanceof Rectangle` refers to the _value_, in this case the con‐
...
output on errors, you can use the `noEmitOnError` option in _tsconfig.json_, or the equiv‐
...
“ `as number` ” is a _type assertion_, sometimes inaccurately called a “cast.” For more on
...
The key is to remember that `boolean` is the _declared_ type. Because it is a TypeScript
...
TypeScript _does_ provide a facility for overloading functions, but it operates entirely at
...
There are two caveats to this:
 ...
 - While there is no _runtime_ overhead, the TypeScript compiler will introduce _build_
_time_ overhead. The TypeScript team takes compiler performance seriously and
...
**Item 3: Understand That Code Generation Is Independent of Types** **|** **17**
 ...
 - The code that TypeScript emits to support older runtimes _may_ incur a perfor‐
...
and is still independent of the _types_ .
...
The `calculateLength` function will work with `NamedVector` s because they have `x` and
`y` properties that are `number` s. TypeScript is smart enough to figure this out:
...
`calculateLength` for `NamedVector` s. TypeScript’s type system is modeling JavaScript’s
runtime behavior (Item 1). It allowed `calculateLength` to be called with a
`NamedVector` because its _structure_ was compatible with `Vector2D` . This is where the
...
having the properties you’ve declared _and no others_ . This is known as a “closed,”
...
`number` s, so shouldn’t the type of `coord` be `number` ?
...
Structural typing can also lead to surprises with `class` es, which are compared struc‐
...
TypeScript’s type system is _gradual_ and _optional_ : _gradual_ because you can add types to
your code bit by bit (with `noImplicitAny` ), and _optional_ because you can disable the
...
_Figure 1-3. The TypeScript Language Service is able to provide contextual autocomplete_
_for symbols with types._


But for symbols with an `any` type, you’re on your own (Figure 1-4).


_Figure 1-4. There is no autocomplete for properties on symbols with_ _`any`_ _types._
...
_Figure 1-5. Renaming a symbol in VS Code._


_Figure 1-6. Choosing the new name._
...
harder to work with than untyped JavaScript because you have to fix type errors _and_
...
every bit as important because it provides _language services_ . These include autocom‐
...
_Figure 2-1. An editor (VS Code) showing that the inferred type of the_ _`num`_ _symbol is_
_`number`_ _._
...
_Figure 2-2. Using an editor to reveal the inferred return type for a function._
...
_Figure 2-3. The type of message is_ _`string | null`_ _outside the branch, but_ _`string`_
_inside._
...
_Figure 2-4. Inspecting how TypeScript has inferred types in an object._
...
_Figure 2-5. Revealing inferred generic types in a chain of method calls._
...
namely, the `HTMLElement` s. But oddly enough, in JavaScript `typeof null` is `"object"`,
...
_Figure 2-6. Renaming a symbol in your editor._
...
_Figure 2-7. The TypeScript language service provides a “Go to Definition” feature that_
_should be available in your editor._


**Item 6: Use Your Editor to Interrogate and Explore the Type System** **|** **31**


Selecting this option takes you into _lib.dom.d.ts_, the type declarations that TypeScript
...
has a _type_ . This is best thought of as a _set of possible values_ . This set is known as the
_domain_ of the type. For instance, you can think of the `number` type as the set of all
...
_Figure 2-8. Values and types as sets of values. The boxes are values (_ _`"A"`_ _,_ _`"B"`_ _,_ _`12`_ _) and_
_the rounded shapes are types (_ _`A`_ _,_ _`B`_ _,_ _`AB`_ _,_ _`AB12`_ _,_ _`Twelve`_ _), which include a set of values. One_
_type is assignable to another if it’s entirely contained within it._
...
That’s _all_ it says. As Item 4 explained, TypeScript’s structural typing rules mean that
...
still belong to a type. So a value that has the properties of _both_ `Person` _and_ `Lifespan`
...
The intuition about intersecting properties is correct, but for the _union_ of two inter‐
...
makes sense when you think about the domains of these two `interface` s. If you try
...
domain is a subset of the other’s. Thinking in terms of one-, two-, and threedimensional vectors:
...
_Figure 2-9. Two ways of thinking of type relationships: as a hierarchy or as overlapping_
_sets._
...
_Figure 2-10. Union types may not fit into a hierarchy but can be thought of in terms of_
_sets of values._
...
_equality_ . This makes it challenging to write tests for types, which is the subject of
Item 55.
...
_Table 2-1. TypeScript terms and set terms_
...
values _and the things you can do with them_ .” Item 14 has more to say about `readonly`
...
**Things to Remember**
 ...
 - Think of types as sets of values (the type’s _domain_ ). These sets can either be finite
...
One of the best ways to build an intuition for the two spaces is through the [Type‐](https://oreil.ly/R0_D5)
[Script playground, which shows you the generated JavaScript for your TypeScript](https://oreil.ly/R0_D5)
...
_Figure 2-11. The TypeScript playground showing generated JavaScript. The symbols on_
_the first two lines go away, so they were in type space._
...
containing the runtime type of the symbol. This is _not_ the same as the TypeScript
...
`Person['first']` is a _type_ here since it appears in a type context (after a `:` ). You can
...
`Person` ) adds a _type annotation_ to the variable and ensures that the value conforms to
the type. The latter ( `as Person` ) performs a _type assertion_ . This tells TypeScript that,
...
they are often mistakes. TypeScript has an additional tool known as _excess property_
_checking_ that flags extra properties in objects with declared types, but it doesn’t apply
...
as a start tag in _.tsx_ files (TypeScript + React).
...
So when _should_ you use a type assertion? Type assertions make the most sense when
...
ods. You might object that strings _do_ have methods:
...
tle going on here. While a string _primitive_ does not have methods, JavaScript also
defines a `String` _object_ type that does. JavaScript freely converts between these types.
...
These are the `BigInt` and `Symbol` _values_, not the TypeScript types (Item 8). Calling
...
**Item 11: Distinguish Excess Property Checking from**
**Type Checking**

When you assign an object literal to a variable with a declared type, TypeScript makes
sure it has the properties of that type _and no others_ :
...
from a structural typing point of view (Item 4). That constant _is_ assignable to the
...
`string` and _any other properties_, so long as those don’t include a `darkMode` property
...
A related check happens for so-called “weak” types, which have _only_ optional
properties:
...
JavaScript (and TypeScript) distinguishes between a function _statement_ and a func‐
tion _expression_ :
...
declarations for `fetch` in _lib.dom.d.ts_ look like this:
...
there are union `type` s but no union `interface` s:

```
  type AorB = 'a' | 'b';
```

An `interface` can extend some `type` s, but not this one. Extending union types can
...
than an `interface` . It can be a union, and it can also take advantage of fancy typelevel features like mapped types (Item 15) and conditional types (Item 52).
...
son to use `extends` with `interface` s.
...
that an `interface` can be _augmented_ . Going back to the `State` example, you could
...
standard library. The `Array` interface, for example, is defined in _lib.es5.d.ts_ :
...
If you set `target` to ES5 in your _tsconfig.json_ (Item 2), then this is all you get. This
...
_lib.es2015.core.d.ts_ . This includes another declaration of the `Array` interface:
...
_can_ happen in user code, but only if the two `interface` s are defined in the same
module (i.e., the same _.ts_ file). This prevents accidental collisions with global `inter`
`face` s with generic-sounding names like `Location` and `FormData` .
...
also affect concrete outputs such as _.d.ts_ files, which TypeScript will emit if you set
`declaration: true` in your _tsconfig.json_ .
...
( `Hummingbird` ). Even more interesting is what happens when you generate a _.d.ts_ file
for this code:
...
generated _.d.ts_ file. In some cases, this inlining behavior can cause duplication of
...
1 If you don’t see this error, make sure to set `declaration: true` set in your _tsconfig.json_ .
...
**Item 14: Use readonly to Avoid Errors Associated**
**with Mutation**
...
_are_ mutable. This is where TypeScript’s `readonly` modifier comes in.
...
Typically, you’ll want to prevent assignments to _all_ properties on an object. Type‐
...
(Focus on the `readonly` s: the change from `interface` to `type` isn’t important here.)
...
and `ReadonlyArray` interfaces. Here’s what `Array<T>` looks like (in _lib.es5.d.ts_ ):
...
We can’t declare that `nums` is `readonly number[]` since _we_ still need to mutate it. We
...
(Note that you can still _reassign_ `readonly` parameters. They’re like variables declared
...
**Item 15: Use Type Operations and Generic Types to Avoid**
**Repeating Yourself**
...
While it’s longer, this _is_ progress: a change in the type of `pageTitle` in `State` will get
reflected in `TopNavState` . But it’s still repetitive. You can do better with a _mapped_
_type_ :
...
_Figure 2-12. Showing the expanded version of a mapped type in your text editor. This is_
_the same as the initial definition, but with less duplication._
...
(This definition isn’t _quite_ complete. We’ll revisit it in Item 50.) You use it like this:

```
  type TopNavState = Pick<State, 'userId' | 'pageTitle' | 'recentFiles'>;
```

`Pick` is an example of a _generic type_ . Continuing the analogy to removing code dupli‐
...
This works particularly well with _template literal types_, which let you manipulate
...
_Figure 2-13. The TSDoc documentation has been copied over to the homomorphic map‐_
_ped type._
...
You may also find yourself wanting to define a type that matches the shape of a _value_ :
...
Note that `ReturnType` operates on `typeof getUserInfo`, the function’s _type_, rather
than `getUserInfo`, the function’s _value_ . As with `typeof`, use this technique judi‐
...
ture of the type, not what it _is_ . The `Vertebrate` type from before, on the other hand,
...
2 [Sandi Metz, “All the Little Things”, RailsConf 2014.](https://oreil.ly/XRdLA)
...
lets you represent flexible mappings like this by specifying an _index signature_ on the
type:
...
In addition to being a better model of dynamic data, `Map` s work around some famous
...
safety and reduce the value of language services.
 ...
 - Prefer more precise types to index signatures when possible: `interface` s, `Map`,
...
In particular, _numbers_ cannot be used as keys. If you try to use a number as a prop‐
...
ferent. A variable has a type _at a location_ in your code. The process by which its type
changes due to surrounding code is known as _control flow analysis_ .
...
base from JavaScript is fill it with type annotations. TypeScript is about _types_, after all!
...
_Figure 3-1. A text editor showing that the inferred type of_ _`x`_ _is number._
...
have multiple `return` statements. If you want TypeScript to check that all the `return` s
...
tion: you should know what its input and output types are _before you implement it_ .
...
_Figure 3-2. The parameters to the_ _`add`_ _function have named types, but the inferred_
_return value does not._
...
_Figure 3-3. The inferred type of_ _`productId`_ _is_ _`string`_ _._
...
This leads us to a key insight about variables in TypeScript: _while a variable’s value can_
_change, its type generally does not_ . The one common way a type can change is to nar‐
...
must be broad enough to encompass both `string` s and `number` s. This is the very defi‐
...
While these two `productId` s share a name, they are actually two distinct variables
...
time, when TypeScript is checking your code, a variable has a set of _possible_ values,
...
cess is known as _widening_ . Understanding it will help you make sense of errors and
...
type for it. There is _no_ widening. For true constants, this is typically what you want.
...
for example, the code would still pass the type checker but might lead to `NaN` s or
...
a symbol has a type _at a location_ . Learn to take advantage of this and you’ll write
...
bly the `filter` method on `Array` s:
...
sponds to the type predicate it returns. (In this case, in fact, there are a few `Element` s
...
It’s also helpful to understand when types _don’t_ narrow. One notable example is in
callbacks:
...
you have created an _alias_ . Changes to properties on the alias will be visible on the
...
the errors. This leads us to the golden rule of aliasing: _if you introduce an alias, use it_
_consistently_ .
...
Unfortunately this is _too_ precise! The type signature of `panTo` makes no promises that
...
it can be _narrowed_ (by checking if it is `null`, for instance; see Item 22), but it cannot
...
type is only “evolved” _after_ you assign or push an element. Inspect‐
...
Put another way, evolving types are only `any` when you _write_ to them. If you try to
_read_ from them while they’re still `any`, you’ll get an error. This isn’t the scary `any` that
...
When you build an array by `push` ing elements onto it or set a value conditionally,
...
**Things to Remember**
 ...
 - While TypeScript types typically only _refine_, the types of values initialized to
`null`, `undefined`, or `[]` are allowed to _evolve_ .
...
**Item 26: Use Functional Constructs and Libraries to**
**Help Types Flow**
...
tion (the type checker doesn’t know that the `players` array passed to `_.maxBy` is nonempty). It makes use of a “chain,” a concept in Lodash and Underscore that lets you
...
**Item 27: Use async Functions Instead of Callbacks to**
**Improve Type Flow**
...
resolves. Within an `async` function, `await` ing a Promise that rejects will throw an
...
can let TypeScript infer _all_ the type parameters from usage, or you can specify all of
...
Script, it turns out that classes are also very good at capturing _types_ .
...
_currying_, after the logician Haskell Curry, who always disavowed having come up
with the technique.
...
Now `fetchAPI` takes _no_ parameters, but it returns a function that takes one. Here’s
how you use it:
...
—Fred Brooks, _The Mythical Man Month_ (Addison-Wesley Professional)
...
**Item 30: Be Liberal in What You Accept and Strict in**
**What You Produce**

This idea is known as the _robustness principle_ or _Postel’s Law_, after Jon Postel, who
...
You can specify the bounds either using named corners, a pair of `lat` / `lng` s, or a fourtuple if you’re confident you got the order right. Since `LngLat` already accommodates
...
_produces_ . The only type-safe way to use the `camera` result is to introduce a code
...
**Item 31: Don’t Repeat Type Information**
**in Documentation**
...
from the type signature.
 ...
 - It’s needlessly wordy: the comment is longer than the function declaration _and_
implementation!
...
The comment _says_ that this function doesn’t modify its parameter, but the `sort`
...
user, rather than _maybe_ representing a user.
...
senting something _or_ `null` or `undefined` .
...
This sort of object with several `undefined` s will be difficult for clients to work with
...
Recall from Item 7 that the _domain_ of a type is the set of values assignable to that
type. The domain of the `string` type is enormous: `"x"` and `"y"` are in it, but so is the
complete text of _Moby Dick_ (it starts with `"Call me Ishmael…"` and is about 1.2 mil‐
...
`'Studio'` is capitalized where it should be lowercase. But these values _are_ both
...
parameters of _any_ type can be problematic, not just `string` .)

Can you make the types narrower to prevent these sorts of issues? While the com‐
plete text of _Moby Dick_ would be a ponderous artist name or album title, it’s at least
...
_Figure 4-1. Using a named type instead of_ _`string`_ _makes it possible to attach documen‐_
_tation to the type that is surfaced in your editor._
...
right to do so: if you pass in an array of `Album` s then there are only four valid values
...
rower than `string`, it’s _still_ too broad. To narrow it further, we need to introduce a
...
_Figure 4-2. Using a parameter type of_ _`keyof Album`_ _instead of_ _`string`_ _results in better_
_autocomplete in your editor._
...
This item focused on finite sets of `string` s, but TypeScript also lets you model infinite
sets, for example, all the `string` s that start with “http:”. For these, you’ll want to use
...
While it’s not entirely clear what the function _should_ do in this case, it’s definitely not
...
return a primitive _or_ null. Only objects (or pointers) are nullable. So this behavior
...
you enable `strictNullChecks`, TypeScript _does_ distinguish between these types and
...
ever we don’t, metric users will see confusing imperial units like yards, acres, or footpounds.
...
if you have _N_ optional properties then there are 2 _[N]_ possible combinations of them.
...
As you’ve seen, there are lots of reasons to avoid optional properties. So when _should_
...
As Scott Meyers wrote in _Effective C++_, “Make interfaces easy to use correctly and
...
If it’s available to you, though, a better option than _modeling_ the difference between
two types is to _eliminate_ the difference between those two types. Then no type-level
...
can use template literal types to _type_ this function. Item 54 walks through how to do
...
_will_ allow all valid Mapbox expressions. There will be no false positive errors. But
...
This book has had much to say about the _shape_ of types and the sets of values in their
domains, but much less about what you _name_ your types. But this is an important
...
1 GeoJSON is also known as RFC 7946. The very readable spec is at _[http://geojson.org](http://geojson.org)_ .
...
One option for fixing the bug is to explicitly disallow `GeometryCollection` s:
...
But the better solution is to support `GeometryCollection` s! You can do this by pull‐
...
format, which did not include `GeometryCollection` s. This led to a false sense of secu‐
rity about our code’s correctness. Using community types based on a spec gives you
confidence that your code will work with _all_ values, not just the ones you happen to
have seen.
...
This results in nice, clean `interface` s that will help you interact with this API in a
...
_optional_ and _gradual_ . You’re free to add types to parts of your program but not others.
...
_unsoundness_ : when a symbol’s static type does not match its runtime type. Even if you
eliminate all the `any` s from your code, you may still fall into soundness traps. Item 48
...
The stakes become significantly higher if you _return_ `pizza` from `eatDinner` . Look
what happens:
...
**Item 46: Use unknown Instead of any for Values with an**
**Unknown Type**
...
The `unknown` type is an alternative to `any` that _does_ fit into the type system. It has the
...
**Item 47: Prefer Type-Safe Approaches to**
**Monkey Patching**
...
tured. Monkey patching shouldn’t be _too_ easy!
...
As we saw previously, TypeScript as a whole is emphatically _not_ sound. In fact, sound‐
...
statically. Take a look at the parameter list for `String.prototype.replace` for a headscratching example:
...
_covariant_ in their return types.
...
`string` with a `boolean` . Functions are _contravariant_ in their parameter types.
...
TypeScript models methods on classes as _bivariant_ : if either the parent or the child
method is assignable to the other, then it’s valid. Historically this was how _all_ function
...
What can _you_ do about it? It’s best not to mutate function parameters, which you can
...
`undefined` to `string` . This is sound. However, the call to `processor(fact)` _should_
...
**Item 49: Track Your Type Coverage to Prevent Regressions**
**in Type Safety**
...
_Through explicit_ `any` _types_
...
`{[key: string]: any}` become plain `any` s once you index into them, and the
...
_From third-party type declarations_
...
These are worth investigating because they’re likely to turn up sources of `any` s that
...
Another common source of `any` s with third-party declarations is when there’s a bug
...
_Figure 5-1. Symbols with an_ _`any`_ _type highlighted in your editor. None of these would_
_have been_ _`noImplicitAny`_ _errors._
...
through explicit `any` s or third-party type declarations ( `@types` ).
...
[(TypeScript’s type system is Turing Complete, so this is true in a formal sense.) Rather](https://oreil.ly/snlm0)
...
driven in part by the [Type Challenges project, which includes hundreds of increas‐](https://tsch.js.org)
...
or pleasant language to work with. Just because you _can_ write logic at the type level
doesn’t mean it’s always a good idea. Overuse of generic types can lead to cryptic,
hard-to-maintain code. Josh Goldberg puts it well in _[Learning TypeScript](https://learning.oreilly.com/library/view/learning-typescript/9781098110321/ch10.html#idm46046659582512)_ (O’Reilly):
...
a _generic type_ . A generic type takes one or more _type parameters_ and produces a con‐
...
Here `T` is the type parameter. You can see that this works exactly the same as the builtin `Partial` type:
...
_Figure 6-1. The_ _`@template`_ _TSDoc tag can be used to document a type parameter._
...
Here’s what the official _[TypeScript Handbook](https://oreil.ly/j7PWM)_ has to say about generic functions:
...
appears once, so it must be bad. How to fix it? It depends what your goal is. These socalled “return-only generics” are dangerous because they’re equivalent to a type asser‐
...
So `K` _does_ appear twice! This is a good use of generics: `K` is related to `T`, and the return
...
3 There’s a famous adage for object-oriented programmers: “Don’t make objects that end with _er_ .”
...
Unfortunately, in our zeal for precision we’ve overshot. The types are now a little _too_
precise. When passed a `string` type, this `double` declaration will result in a `string`
type, which is correct. But when passed a string _literal_ type, the return type is the
...
is to use a _conditional type_ . Conditional types are like `if` statements (conditionals) in
...
The `string|number` example works because conditional types _distribute_ over unions.
...
tions like `readFile` . This _could_ be a single function that behaves differently depend‐
...
types. But it’s worth briefly discussing how to _implement_ overloaded functions and
...
This _should_ be `[bigint, bigint] | [bigint, bigint, bigint]` . The immediate
...
previous items, it also has string _literal_ types, which are types whose domain consists
...
comes when we combine them with generics and type inference to capture _relation‐_
_ships_ between types.
...
larations for the DOM ( _lib.dom.d.ts_ ) include a mapping from tag name to type:
...
_Write tests until fear is transformed into boredom._
—Phlip (quoted in Kent Beck, _Test Driven Development: By Example_ [Addison-Wesley
Professional])
...
ming languages for two reasons:
 ...
 - TypeScript lets you put an enormous amount of logic in the _types_ . Where there’s
...
item will first look at some _ineffective_ ways to test types, then talk about the pros and
...
A second issue is that we’re checking _assignability_ of the two types rather than equal‐
...
This assigns an `any` type to the _entire module_ . Your type assertions will all pass, but
...
_isn’t_ a type error. This does give you some protection against `any` types, but be
...
though. With some cleverness, you _can_ detect an `any` type using a type alias. But
...
[Another approach in this vein was popularized by the Type Challenges repo. It looks](https://tsch.js.org)
like this:
...
_Figure 6-2. TypeScript offers autocomplete for two values, but accepts all strings._


Testing type declarations is tricky business. You _should_ test them. But be aware of the
...
Usually, we care about what types _are_ and which values are assignable to them. But
when you’re using a TypeScript library, the way it chooses to _display_ types can make a
...
6 For TypeScript, see _[https://oreil.ly/C5EzQ](https://oreil.ly/C5EzQ)_ .
...
stack: its work is done and it doesn’t need it any more. This is known as _Tail Call_
_Optimization_ (TCO) and functions with this form are called _tail recursive_ .
...
gishness in the type checker. But it supports Tail Call Optimization and gives tailrecursive type aliases a much greater depth limit. Because they are more efficient and
...
**Item 58: Consider Codegen as an Alternative to**
**Complex Types**

_Beware of the Turing tar-pit in which everything is possible but nothing of interest is easy._
—Alan Perlis
...
For our SQL queries, one option is to use the PgTyped library. It finds appropriatelytagged SQL queries in your TypeScript, examines them against a live database, and
...
( _pgtyped.config.json_ is a file that tells PgTyped how to connect to your database)
...
and some changes to _books-queries.ts_ :
...
Stefan Baumgartner’s _[TypeScript Cookbook](https://learning.oreilly.com/library/view/typescript-cookbook/9781098136642/)_ .
...
add a return type annotation to any function with multiple `return` s.
...
_pairs_ of two types, i.e., the cross-product. For example, say you write some code to
...
The function `foo` can be called with any value _assignable_ to `ABC`, not just a value with
...
Another reason that TypeScript infers `string` in `for-in` loops is _prototype pollution_ .
...
`Map` s are easier to iterate over because they don’t have the same structural behavior as
...
_necessary_ draws that get dropped. An important principle in optimization is to “first,
...
**Item 62: Use Rest Parameters and Tuple Types to Model**
**Variadic Functions**
...
**Item 63: Use Optional Never Properties to**
**Model Exclusive Or**
...
JavaScript’s runtime or ( `||` ), TypeScript’s type-level or ( `|` ) is an _inclusive_ or. There’s no
reason a thing can’t be both a `ThingOne` _and_ a `ThingTwo` :
...
`ThingOne` s and `ThingTwo` s separate? How can you model that?

The standard trick is to use an _optional_ _`never`_ type in your interface to disallow a
property:
...
_optional_, there’s exactly one way out: not having that property.
...
A string can’t be both `'one'` _and_ `'two'`, so there’s no overlap between these types.
...
You can use this to construct `ExclusiveThing` directly from the `interface` s at the
start of this item:
...
properties. This is known as _nominal typing_, as opposed to TypeScript’s usual struc‐
...
`dencies`, these are _not_ installed transitively with your packages.
...
The next type of dependency to consider is _type dependencies_ or `@types` . If a library
...
contain the _types_ . They don’t contain the implementation.
...
This will result in a _package.json_ file that looks something like this:
...
**Item 66: Understand the Three Versions Involved**
...
dependency management quite a bit _more_ complicated. This is because instead of
...
the type declarations. But the type declarations _themselves_ might have bugs or omis‐
...
type declarations. This is usually indicated by a `"types"` field in their _package.json_
which points to a _.d.ts_ file:
...
Bundling types _does_ solve the problem of version mismatch, particularly if the library
...
The reason is that there is a nearly universal convention in editors to surface JSDocstyle comments when the function is called (see Figure 8-1).


_Figure 8-1. JSDoc-style comments are shown in tooltips in your editor._


The inline comment, in contrast, gets no such treatment (see Figure 8-2).


_Figure 8-2. Inline comments are typically not shown in tooltips._
...
_Figure 8-3. An @param annotation lets your editor show documentation for the current_
_parameter as you type it._
...
_Figure 8-4. TSDoc for a field is shown when you mouse over that field in your editor._
...
_Figure 8-5. TSDoc comments can include Markdown formatting._
...
_Figure 8-6. Symbols marked with the @deprecated tag are struck through._
...
**Item 69: Provide a Type for this in Callbacks if It’s Part of**
**Their API**
...
`C.prototype.logSquares` _and_ it binds the value of `this` in that function to `c` . By
...
`--declaration` and bundle them with it. Here’s what the generated _.d.ts_ file looks
like:
...
that you have to. Recall from Item 13 that `interface` s have a special power that type
...
Here’s the declaration of `Set` from _lib.es2015.collections.d.ts_ :
...
There’s also an overload of the constructor in _lib.es2015.iterable.d.ts_ :
...
Many languages model types that can take on a small set of values using _enumerations_
or _enums_ . TypeScript adds them to JavaScript:
...
`const enum` _with the_ `preserveConstEnums` _flag set_
...
_Figure 9-1. TypeScript offering autocomplete for a union of string literal types._
...
Script ( `enum` s are another). Generally, compilation just involves erasing types.
...
If your class consists _only_ of parameter properties and no methods, you might con‐
...
`Decorators` in your _tsconfig.json_ . If it’s set, then you’re using nonstandard decorators.
...
implies encapsulation, `protected` implies inheritance. The general rule in objectoriented programming is to prefer composition over inheritance, so practical uses of
...
_Figure 9-2. Debugging generated JavaScript using Chrome’s developer tools. For this sim‐_
_ple example, the generated JavaScript closely resembles the TypeScript source._
...
_Figure 9-3. The TypeScript compiler has generated JavaScript that doesn’t closely resem‐_
_ble the original TypeScript source. This will make debugging more difficult._
...
To tell TypeScript to generate one, set the `sourceMap` option in your _tsconfig.json_ :
...
Now when you run `tsc`, it generates two output files for each _.ts_ file: a _.js_ file and
a _.js.map_ file. The latter is the source map. With this file in place, a new _index.ts_ file
...
_Figure 9-4. When a source map is present, you can work with the original TypeScript_
_source in your debugger, rather than the generated JavaScript._


Note that _index.ts_ appears in italics in the file list on the left. This indicates that it isn’t
a “real” file in the sense that the web page included it. Rather, it was included via the
source map. Depending on your settings, _index.js.map_ will contain either a reference
to _index.ts_ (in which case the browser loads it over the network) or an inline copy of
...
To debug this, compile it to JavaScript with `sourceMap` set in your _tsconfig.json_ . Then
...
_chrome://inspect_ . You should see a remote target that you can “Inspect,” as shown in
Figure 9-5.


_Figure 9-5. Selecting a remote debug target to inspect in Google Chrome (_ chrome://
inspect _)._
...
_Figure 9-6. Generated JavaScript for a Node.js program in Google Chrome Devtools._
_Note the source map reference at the bottom._
...
_Figure 9-7. Debugging the original TypeScript source for a Node.js program._
...
If you generate _.d.ts_ files for your project (by setting the `declaration` option), Type‐
Script can also generate _.d.ts.map_ files that map your type declarations back to the
...
To make this work we’ll put our API types in an _api.ts_ file:
...
Now we can load _api.schema.json_ at runtime. If you enable TypeScript’s `resolveJson`
...
you change _api.ts_, you’ll need to regenerate _api.schema.json_ . In practice, you’d want to
...
your `Node` s from your `Element` s and `EventTarget` s will help you debug type errors
...
_Table 9-1. Types in the DOM hierarchy_
...
Moving up the hierarchy we come to `Node` . `Node` s that are not `Element` s include text
...
child `Element` s ( `<i>yet</i>` ). `childNodes` returns a `NodeList`, an array-like collec‐
tion of `Node` s. This includes not just `Element` s ( `<i>yet</i>` ) but also text fragments
...
What’s the difference between an `Element` and an `HTMLElement` ? There are nonHTML `Element` s including the whole hierarchy of SVG tags. These are `SVGElement` s,
...
then, in practice, all your `Element` s will be `HTMLElement` s.
...
(Item 54 explores another way to get more precise types for `HTMLElement` s.)
...
In addition to the hierarchy for `Node` s and `Element` s, there is also a hierarchy for
`Event` s. TypeScript’s _lib.dom.d.ts_ defines no fewer than 54 subtypes of `Event` !
...
tions for a browser. The `"es2021"` indicates that we expect the browser to have builtin support for everything in the JavaScript standard from that year (either natively or
...
to do this is with multiple _tsconfig.json_ files and project references, which are dis‐
cussed in Item 78.
...
ment that you use.
 ...
 - Use multiple _tsconfig.json_ files and project references to model distinct environ‐
...
TypeScript _can_ have an impact on the performance of your developer tooling, how‐
...
`tsc` _, the TypeScript compiler_
...
duce build artifacts ( _.js_ and _.d.ts_ files).

`tsserver` _, the TypeScript Language Service_
...
run the generated JavaScript. But they don’t _need_ to do this. You can tell any of them
...
_Figure 9-8. Treemap of the files that TypeScript considers, weighted by file size._
...
To set up project references, you create a _tsconfig.json_ file for each distinct part of
...
a top-level _tsconfig.json_ for shared configuration. Here’s what the setup might look
like:
...
That’s a lot of configuration! Here are the interesting bits:
 ...
 - The `src` and `test` _tsconfig.json_ inherit a shared base configuration that sets
`composite` and `declaration` (to output _.d.ts_ files).


**340** **|** **Chapter 9: Writing and Running Your Code**


 - The top-level _tsconfig.json_ consists only of a list of references to subprojects.

 - The `test` _tsconfig.json_ references `src` but not the other way around.


With this setup in place, you can run `tsc` with the `-b` / `--build` flag to make it act as a
sort of build coordinator. After a first run, if you make a change to _src/fib.ts_ that does
...
The last line is the important one. Our change didn’t affect the _.d.ts_ files (it was an
...
puts _.d.ts_ files on disk. If you use `noEmit` or run `tsc` via `webpack`, `vite`, or some
...
types more efficient include:
 ...
 - Extend `interface` s rather than intersecting `type` aliases. Item 13 goes into great
...
1 [Z. Gao, C. Bird, and E. T. Barr, “To Type or Not to Type: Quantifying Detectable Bugs in JavaScript”, ICSE](https://oreil.ly/4RFfI)
2017.

2 [Brie Bunge, “Adopting TypeScript at Scale”, JSConf Hawaii 2019.](https://oreil.ly/i-L60)
...
of the _latest_ version of JavaScript, this means that you can use `tsc` as a “transpiler”:
...
`"commonjs"` in your _tsconfig.json_, for example, TypeScript would compile the second
...
_Figure 10-1. The TypeScript language service offers a quick fix to convert older-style_
_classes to ES2015 classes._
...
_Effective JavaScript_ . But better to avoid `var` and not worry!
...
[even have to wait for the ink to dry. Check out the TC39 GitHub repo for the latest.](https://oreil.ly/OT8Uu)
...
**Item 80: Use @ts-check and JSDoc to Experiment**
**with TypeScript**
...
then you could create a file called _types.d.ts_ :
...
You may need to adjust your _tsconfig.json_ file so that TypeScript is aware of this file. If
it is, it will make the error disappear.

This _types.d.ts_ file is a valuable artifact because it models the environment in which
...
TypeScript code. As a quick recap, the issue is that only `HTMLInputElement` s have a
...
_Figure 10-2. The TypeScript Language Services offer a quick fix to infer parameter types_
_from usage._
...
with _.ts_ files, not _.js_ files. The goal is ultimately to convert your project to TypeScript,
...
_before_ you ask management to commit to a weeks- or months-long TypeScript
transition.
...
Remember that the goal is to convert to _.ts_ !
...
and configure it in your _webpack.config.js_ :
...
install `ts-jest` and pass TypeScript sources through it by specifying a _jest.config.js_
like:
...
with it. This implies that you should convert modules going _up_ the dependency
...
The bottom of this dependency graph is the circular dependency between _utils.js_ and
_tickers.js_ . There are many modules that import these two, but they only import each
...
_Figure 10-3. The dependency graph for a medium-sized JavaScript project. Arrows indi‐_
_cate imports. Darker-shaded boxes indicate that a module is involved in a circular_
_import._
...
do. When you rename a class’s _.js_ file to _.ts_, it’s likely to show errors for every single
...
_Figure 10-4. The quick fix to add declarations for missing members is particularly help‐_
_ful in converting a class to TypeScript._
...
for a shock. When I converted the main class in _dygraph.js_ (the root module in
...
_lose_ type safety by converting to TypeScript. For instance, TypeScript flags an error in
this JavaScript:
...
_Figure 10-5. Quick fix to copy JSDoc annotations to TypeScript type annotations._
...
**Item 83: Don’t Consider Migration Complete Until You**
**Enable noImplicitAny**

Converting your whole project to _.ts_ is a big accomplishment. But your work isn’t
...
tions without committing the _tsconfig.json_ change to your repo until you get the
...
distinct _tsconfig.json_ files with different strictness settings for different parts of your
project.
...
**APPENDIX**
#### **Item Mapping Between** **First and Second Editions**
...
won’t match the second. If you see a reference to an _Effective TypeScript_ item that
...
_Table A-1. First edition to second edition item mapping_
...
_[effectivetypescript.com](https://effectivetypescript.com)_ and at _[danvk.org](https://www.danvk.org)_ . He earned his bachelor’s in Computer Sci‐
ence from Rice University in Houston, Texas, and lives in Wallkill, New York.


**Colophon**

The animal on the cover of _Effective TypeScript_ is a red-billed oxpecker ( _Buphagus_
_erythrorhynchus_ ). These birds inhabit a fragmented range across eastern Africa, from
...
_Elements of Ornithology_ . The series design is by Edie Freedman, Ellie Volckhausen,
...
[Books | Live online courses](https://oreilly.com/)
