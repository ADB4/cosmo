<!--
Topics: object types, optional properties, readonly properties, index signatures, extending types, intersection types, generic object types, tuple types, readonly tuples, array types, ReadonlyArray
Keywords: object type, interface, type alias, optional property, readonly, index signature, string index, number index, intersection type, extend interface, tuple, readonly tuple, readonly array
-->
---
title: Object Types
layout: docs
...
## Extending Types
<!-- Topics: extend type, interface extends, type intersection, inheritance -->
...
## Intersection Types
<!-- Topics: intersection type, & operator, combine types, merge types -->
...
<!-- Topics: generic interface, generic type alias, parameterized types -->
