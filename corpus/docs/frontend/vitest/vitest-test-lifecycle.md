<!--
Topics: test lifecycle, test run phases, collection phase, execution phase, setup order, teardown order, beforeAll, afterAll, beforeEach, afterEach, test order
Keywords: test lifecycle, test execution order, setup teardown, hook execution, test phases
-->
